...
class MeetingController {
  ...
  verifyMeetingByadmin = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const meetingDetails = await this.meetingService.verifyMeeting(purchase_order_id.toString());
